...
- Name: navigation.spec.ts >> Recipe pages >> recipe page has a footer
- Location: e2e/navigation.spec.ts:135:7
...
```ts
  37  |       .locator("nav a, header a")
  38  |       .filter({ hasText: /Tools/i })
  39  |       .first();
  40  |     await expect(toolsLink).toBeVisible();
  41  |   });
  42  | 
