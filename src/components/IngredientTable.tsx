...
const IngredientTable: React.FC<Props> = ({
  ...
  shoppingModeToggled,
  shoppingProvider,
  showHeader = true, // default to preserve old behavior
}) => {
          ...
          return (
            <ListItem
              ...
              sx={{
                px: 2,
                py: { xs: 1.0, md: 0.9 },
                borderBottom: idx === data.length - 1 ? "none" : "1px solid",
                borderColor: "divider",
                display: "flex",
                alignItems: "center",
                gap: 1,
              ...
              <ListItemText
                ...
                primary={
                  <Typography variant="body1">
                    <strong>{ingredient.amount}</strong> {ingredient.unit}{" "}
                    {ingredient.metric && (
                      <>
